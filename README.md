...
In terms of the validity of this model, due to the returns being geometrically symmetric this results in a drift in prices hence for more accurate estimation it would be better to use Log-Returns.
